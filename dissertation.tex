...
Sonic Pi was designed to be accessible to primary school children [Aaron2013].
...
Box-Muller transform [Box1958], which transforms a pair of uniform random
...
a Sonic Pi program sounds the same each time it is run [Aaron2016].
