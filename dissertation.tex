...
The project proposal (Appendix~TODO) features a list of success criteria outlining the
...
\begin{enumerate}
    \item \label{hypothesis_1} Participants think samples with the data-derived micro-timing (the ``correct'' timing) fits the style best
...
Manjanin \cite{polak2010}, and the full recording. For the waltz, these consisted of
...
results of my data analysis in Section~\ref{micro-timing_estimation_results} showed a SML pattern, so offsets for this
...
that Hypothesis~\ref{hypothesis_2} is true for jembe, there is also insufficient evidence to accept it.
...
Hypothesis~\ref{hypothesis_1} is supported by the data for the waltz style.
